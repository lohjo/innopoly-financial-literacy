/* Server-side allowlisted lesson language — mirrors tutor-service/app/catalog.py */

export type CatalogCriterion = { id: string; label: string };
...
export const LESSON_CATALOG: Record<string, Record<string, CatalogScreen>> = {
  "night-it-lands": {
    "predict-leftover": {
      screen_kind: "predict",
      prompt:
    ...
    "quiz-pyf": {
      screen_kind: "quiz",
      prompt: "Why route savings on payday instead of saving whatever is left at month end?",
      criteria: [],
    },
  },
  "missing-740": {
    ...
    "predict-employer": {
      screen_kind: "predict",
      prompt: "Compare what reaches your account with what an employer contributes.",
      criteria: [],
    },
    "quiz-lost": {
      screen_kind: "quiz",
  ...
  "minimum-payment-trap": {
    ...
    "quiz-apr": {
      screen_kind: "quiz",
      prompt: "Two ways to borrow $3,000: only $90/month or $285/month for 12 months. How do you compare them?",
      criteria: [],
    },
  },
};
